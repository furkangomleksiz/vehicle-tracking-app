...
youtube_url = "https://www.youtube.com/live/E8LsKcVpL5A?si=Ps1zEDyc4KDGBv3B"

# Step 1: Get direct video stream URL using yt_dlp
...
# Step 2: OpenCV capture from livestream
...
while True:
    ...
    for result in results:
        for box in result.boxes:
            ...
            conf = float(box.conf[0])  # confidence score from YOLOv8
            ...
            if track_id not in counted_ids and track_ages[track_id] > 30:
